                ...
                <div className="container">
                    ...
                    <div className="row gy-5">
                        ...
                        <div className="col-xl-6" data-aos="zoom-out" data-aos-delay="100">
                            <img src="assets/img/banner/banner10.jpg" className="img-fluid" alt="" />
                        </div>
                        ...
                        <div className="col-xl-7 d-flex order-2 order-xl-1" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div className="row align-self-center gy-5">
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        <h4>Top Brands Collection</h4>
                                        <p>
                                            Shop the latest styles from globally
                                            trusted brands like Adidas, Nike,
                                            Puma, and Mufti. We curate only
                                            premium, high-quality products to
                                            bring you authentic fashion every
                                            time you shop.                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            From casual wear to sportswear, and
                                            everyday basics to trendy outfits —
                                            we've got clothing for men, women,
                                            and kids, all under one roof. Your
                                            entire wardrobe, sorted in one place.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Enjoy reliable doorstep delivery
                                            across India with secure packaging
                                            and real-time tracking. We ensure
                                            your order reaches you quickly,
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Changed your mind or got the wrong
                                            size? No worries. We offer an easy
                                            return and exchange policy to make
                                            sure your shopping experience stays
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            ...
                                            Razorpay. We accept all major
                                            payment methods — including UPI,
                                            cards, wallets, and COD — to keep
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            We love saving you money! Keep an
                                            eye out for exclusive deals, festive
                                            offers, and seasonal sales so you
                                            can grab your favorite styles at the
                                            best prices.
                                        </p>
                                    </div>
                                </div>
