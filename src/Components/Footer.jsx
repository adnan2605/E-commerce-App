            ...
            <div className="col-lg-4 col-md-12">
              ...
              <div className="social-links d-flex">
                <Link to={process.env.REACT_APP_FACEBOOK} target='_blank' rel='noreferrer'>
                  <i className="bi text-light bi-facebook"></i>
                </Link>
                ...
                <Link to={process.env.REACT_APP_INSTAGRAM} target='_blank' rel='noreferrer'>
                  <i className="bi text-light bi-instagram"></i>
                </Link>
                ...
                <Link to={process.env.REACT_APP_YOUTUBE} target='_blank' rel='noreferrer'>
                  <i className="bi text-light bi-youtube"></i>
                </Link>
              </div>
            </div>
