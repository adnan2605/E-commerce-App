...
export default function Cart({ title, data }) {
    ...
    useEffect(() => {
        dispatch(getProduct())
    }, [dispatch, ProductStateData.length])

    return (
        <>
            <h5 className='btn-color text-light text-center p-2'>
                {title}
            </h5>
                                        ...
                                        return (
                                            <tr key={item.id}>
                                                ...
                                                <td className={title !== 'Cart' ? 'd-none' : ''}>
                                                    {
                                                        item.stockQuantity
                                                            ? `${item.stockQuantity} Left in the stock`
                                                            : `Out of Stock`
                                                    }
                                                </td>
                                                ...
                                                <td>
                                                    <div className="btn-group w-100">
                                                        ...
                                                        <button
                                                            className={`btn btn-primary ${title !== 'Cart' ? 'd-none' : ''}`}
                                                            onClick={() => updateRecord(item.id, "DEC")}
                                                        >
                                                            <i className='fa fa-minus'></i>
                                                        </button>

                                                        <h5 className='w-50 text-center pt-2'>
                                                            {item.qty}
                                                        </h5>
