  ...
  return (
    <>
      <div id="carouselExampleCaptions" className="carousel slide">
              ...
              <div className="container">
                <div className="row gy-4">
                  <div className="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100">We Deals in Top 50+ brands and provide upto 90% Descount and top and latest fashion brands</p>
                    <div className="d-flex flex-column flex-md-row" data-aos="fade-up" data-aos-delay="200">
                      <Link to="/shop?mc-Male" className="btn-get-started btn-color">Shop Now <i className="bi bi-arrow-right"></i></Link>
                    </div>
                  </div>
              ...
              <div className="container">
                <div className="row gy-4">
                  ...
                  <h1 data-aos="fade-up">We offer modern and top brands products for Female</h1>
                    <p data-aos="fade-up" data-aos-delay="100">We Deals in Top 50+ brands and provide upto 90% Descount and top and latest fashion brands</p>
                    <div className="d-flex flex-column flex-md-row" data-aos="fade-up" data-aos-delay="200">
                      <Link to="/shop?mc-Female" className="btn-get-started btn-color">Shop Now <i className="bi bi-arrow-right"></i></Link>
                    </div>
                  </div>
                  <div className="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                    <img src="assets/img/banner/banner2.jpg" className="img-fluid animated" alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="container">
                <div className="row gy-4">
                  ...
                  <h1 data-aos="fade-up">We offer modern and top brands products for KIDS</h1>
                    <p data-aos="fade-up" data-aos-delay="100">We Deals in Top 50+ brands and provide upto 90% Descount and top and latest fashion brands</p>
                    <div className="d-flex flex-column flex-md-row" data-aos="fade-up" data-aos-delay="200">
                      <Link to="/shop?mc-Kids" className="btn-get-started btn-color"><span>Shop Now</span><i className="bi bi-arrow-right"></i></Link>
                    </div>
                  </div>
                  <div className="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
        ...
        <button className="carousel-control-prev " type="button" style={{ position: "absolute", margin: "300px 0px "}} data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
