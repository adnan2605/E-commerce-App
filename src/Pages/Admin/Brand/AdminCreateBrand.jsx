                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postData}>
                            <div className='mb-3'>
                                ...
                                <input type="text" name='name' onChange={getInputData} placeholder='Brand Name' className={`form-control border-3 ${show && errorMsg.name ? 'border-danger' : "border-primary"}`} />
