                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postData}>
                            <div className='mb-3'>
                                ...
                                <input type="text" name='name' value={data.name} onChange={getInputData} placeholder='Testimonial Name' className={`form-control border-3 ${show && errorMsg.name ? 'border-danger' : "border-primary"}`} />
                                {show && errorMsg.name ? <p className='text-capitalize text-danger'>{errorMsg.name}</p> : null}
                            </div>

                            <div className="mb-3">
                                <label >Message*</label>
                                <textarea name="message" value={data.message} onChange={getInputData} className={`form-control border-3 ${show && errorMsg.message ? 'border-danger' : "border-primary"}`} placeholder='Message...' rows={5} ></textarea>
